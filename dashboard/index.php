...
<head>
    ...
    <title>Side Buzz - Dashboard</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <!-- <a class="navbar-brand" href="index.php">Side Buzz - Dashboard</a> -->
				<a class="navbar-brand" href="index.php">Welcome, <?php echo $userData['name']; ?>!</a>
            </div>
            <!-- /.navbar-header -->
                                ...
                                <li>
                                    ...
                                    <div class="timeline-panel">
                                        <div class="timeline-heading">
                                            <a href="/ssw"><h4 class="timeline-title">Seattle Startup Weekend</h4></a>
                                            <p>
                                                <small class="text-muted"><i class="fa fa-time"></i> Today, 9:00am</small>
                                            </p>
                                        </div>
